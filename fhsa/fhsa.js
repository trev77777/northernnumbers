...
/* =============================================
   ...
   NN.PROV_BRACKETS, NN.FHSA, NN.RRSP.HBP_MAX). This calculator no
   longer keeps a private copy of tax brackets — see AdSense audit
   Phase 2 (duplicate constants were the cause of stale/conflicting
   figures across calculators).
   ============================================= */
const FHSA_ANNUAL_LIMIT   = (window.NN && NN.FHSA) ? NN.FHSA.ANNUAL_LIMIT : 8000;
const FHSA_LIFETIME_LIMIT = (window.NN && NN.FHSA) ? NN.FHSA.LIFETIME_LIMIT : 40000;
const HBP_MAX             = (window.NN && NN.RRSP) ? NN.RRSP.HBP_MAX : 60000;
const CURRENT_YEAR        = new Date().getFullYear();


/* =============================================
   2. TAX FUNCTIONS — thin wrappers around the shared NN helpers so
   every calculator computes marginal rate/refund the same way.
   ============================================= */
