...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (window.NNSeo) try {
    ...
    NNSeo.injectFAQSchema([
      { question:'Should I include my car in net worth?', answer:'Yes, at current market value — not what you paid. Use Canadian Black Book or similar to estimate your vehicle\'s current value. Include any outstanding car loan as a liability. Most financial planners include vehicles since they have real resale value, though they depreciate quickly and are considered a depreciating asset unlike a home or investment account.' },
      { question:'Should I include my pension in net worth?', answer:'A Defined Contribution (DC) pension has a clear account balance and should be included. A Defined Benefit (DB) pension is harder to value — a rough estimate is to multiply your annual projected pension income by 20–25. For example, a DB pension paying $40,000/year is worth approximately $800,000–$1,000,000 in net worth terms. CPP and OAS are generally excluded from personal net worth calculations since they cannot be transferred or inherited.' },
      { question:'What is a good net worth at 35 in Canada?', answer:'The median Canadian net worth for ages 35–44 is $409,300 (Statistics Canada SFS 2023), driven largely by home equity in those who own. A common rule of thumb is to have a net worth equal to your annual income by 30, double by 35, and four times by 40. But context matters — those who rented through their 20s and invested heavily may have high liquid net worth with no home equity, which is equally valid.' },
      { question:'Is TFSA withdrawal room part of net worth?', answer:'No. Unused TFSA contribution room is not an asset — it\'s simply the capacity to shelter future savings from tax. Only the actual money inside your TFSA accounts counts toward your net worth. Similarly, RRSP deduction limit is not an asset.' },
      { question:'Should I include my TFSA and RRSP in my net worth?', answer:'Yes. Both TFSA and RRSP balances are assets and belong in your net worth calculation. Note that RRSP withdrawals will be taxed as income, so some people use a "tax-adjusted" net worth that discounts the RRSP balance by their expected marginal tax rate in retirement. For a simple calculation, include the full market value of both accounts.' },
      { question:'Does my home count toward net worth?', answer:'Yes — your home\'s current market value is an asset, and the outstanding mortgage balance is a liability. The difference (home equity) is part of your net worth. However, home equity is illiquid — you cannot spend it without selling or borrowing against the property. Many financial planners calculate both a total net worth (including home equity) and a liquid net worth (excluding the primary residence) for a more practical picture of investable assets.' },
    ]);
  } catch(e) {}
