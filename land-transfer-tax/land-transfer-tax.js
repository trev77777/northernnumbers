...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (window.NNSeo) try {
    ...
    NNSeo.injectFAQSchema([
      { question:'When is land transfer tax paid?', answer:'Land transfer tax is paid on closing day — the day your lawyer or notary registers the transfer of title. Your lawyer calculates the amount, collects it from you, and remits it to the province. Quebec is an exception: the welcome tax is billed separately by the municipality, typically 3–6 months after closing. You cannot add LTT to your mortgage.' },
      { question:'Do I pay land transfer tax in Alberta?', answer:'No. Alberta has no land transfer tax. You pay a small title transfer registration fee ($50 base + $2 per $5,000 of property value) and a mortgage registration fee if applicable. On a $750,000 purchase with a $600,000 mortgage, the combined fees are approximately $580 — compared to $11,475 in Ontario. This is one of the major financial advantages of buying in Alberta.' },
      { question:'What is Toronto\'s municipal land transfer tax?', answer:'Toronto is the only city in Canada with its own municipal land transfer tax, charged on top of Ontario\'s provincial tax. The Toronto MLTT uses the same bracket structure as Ontario and effectively doubles the LTT burden for buyers within city limits. On a $750,000 home, you pay $11,475 in provincial LTT plus another $11,475 in Toronto MLTT — a combined $22,950 versus $11,475 in Mississauga or Markham just across the city boundary.' },
      { question:'Is land transfer tax tax-deductible?', answer:'Not for personal residential purchases. LTT is added to the adjusted cost base (ACB) of investment properties, which reduces your capital gain when you eventually sell — providing an indirect tax benefit for real estate investors. For your principal residence, LTT is simply a one-time closing cost with no direct tax deduction.' },
    ]);
  } catch(e) {}
